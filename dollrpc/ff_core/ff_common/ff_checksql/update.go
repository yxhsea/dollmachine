...
func CheckUpdateResult(args interface{}, affectRow int64, err error, mustHasRow bool, msg string, targetId interface{}) error {
	if err != nil {
		fields := make(logrus.Fields)
		fields["ff_checksql"] = "CheckUpdateResult"
