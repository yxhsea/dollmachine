...
const base58alphabet = "1236cdefghLMNijkopqBCDEFrstuv789abwxyzAGHJK45PQRSTmnUVWXYZ"
...
func init() {
	...
	for i := 0; i < len(base58alphabet); i++ {
		decodeMap[base58alphabet[i]] = byte(i)
	}
}
...
func EncodeBig(dst []byte, src *big.Int) []byte {
	...
	for n.Cmp(zero) > 0 {
		...
		dst = append(dst, base58alphabet[mod.Int64()])
	}
